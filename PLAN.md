...
- Current requested day: Not started
- Last fully completed day: None
- Active task: None
...
- [ ] PENDING — Initialize Next.js with TypeScript, Tailwind CSS, App Router, and `src/`.
- [ ] PENDING — Install and configure shadcn/ui, Lucide, Redux Toolkit, React Redux, and Recharts.
- [ ] PENDING — Establish the target folder structure without placeholder clutter.
- [ ] PENDING — Add typed Redux store, provider, and typed hooks.
- [ ] PENDING — Create initial auth, super-admin, and school-admin route groups/pages.
- [ ] PENDING — Add a replaceable mock/API service boundary.
- [ ] PENDING — Add project scripts and basic quality checks.
- [ ] PENDING — Add a useful README with setup and run instructions.
- [ ] PENDING — Confirm the Git repository is healthy and ignores generated/secrets files.
- [ ] PENDING — Run lint, type checking, and a production build.
...
- [ ] PENDING — Define color tokens, typography, spacing, radii, shadows, and responsive conventions.
- [ ] PENDING — Add reusable Button, Input, Select, Checkbox, Radio, Badge, Avatar, and Card components.
- [ ] PENDING — Add Dialog, Dropdown, Tabs, Tooltip, Toast, and Skeleton components.
- [ ] PENDING — Cover applicable default, hover, focus, disabled, loading, error, and success states.
- [ ] PENDING — Add shared form field, validation message, and status presentation patterns.
- [ ] PENDING — Create an internal component showcase page for visual verification.
- [ ] PENDING — Check keyboard use, visible focus, labels, and color contrast.
- [ ] PENDING — Verify the showcase on desktop and mobile sizes.
